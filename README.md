...
- Admin JavaScript avoids bleeding-edge syntax (no optional chaining, helper functions guard absent selectors) so the dashboard keeps working on older shared-hosting browser stacks where evergreen features may be missing.
